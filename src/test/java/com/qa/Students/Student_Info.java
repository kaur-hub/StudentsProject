...
public class Student_Info extends ExtentReportListener {
   ...
   FileReader reader;
   //FileReader reader= new FileReader("C:\\Users\\sukhd\\eclipse-workspace\\Students\\src\\main\\java\\com\\qa\\resources\\student.json");
  
   @Test(priority=1)
   
   public void User_name() throws Exception {
	   logger=reports.startTest("Get username from given jsonfile");
	    reader= new FileReader("C:\\Users\\sukhd\\eclipse-workspace\\Students\\src\\main\\java\\com\\qa\\resources\\student.json");
